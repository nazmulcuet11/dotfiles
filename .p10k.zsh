# Generated by Powerlevel10k configuration wizard on 2019-08-25 at 13:52 +06.
...
() {
  ...
  vcs+='${${${$(($#VCS_STATUS_LOCAL_BRANCH<=80)):#0}:+${VCS_STATUS_LOCAL_BRANCH//\%/%%}}'
  # If local branch name is over 32 characters long, show the first 12 … the last 12.
  vcs+=':-${VCS_STATUS_LOCAL_BRANCH[1,30]//\%/%%}%28F…%76F${VCS_STATUS_LOCAL_BRANCH[-30,-1]//\%/%%}}}'
